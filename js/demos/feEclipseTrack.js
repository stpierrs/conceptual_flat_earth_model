...
//   not to fake this with the sky-observations table. This file provides the
//   structural entry point so future serials can drop in the real
//   prediction logic without disturbing the sky-observations-based solar /
//   lunar demo tracks.
//
...
export const FE_ECLIPSE_PREDICTION_DEMOS = [
  {
    ...
    tasks: () => [
      Ttxt('FE eclipse-prediction track is a structural placeholder. '
         ...
         + 'disturbing the sky-observations-based solar/lunar demos.'),
    ],
  },
];
