#!/usr/bin/env node
// phase3Calibrate.mjs — Phase 3: fit second-epicycle parameters to sky-reference.
//
// For each outer body, find (r2, phase) that minimise RMS angular error
// vs the sky-reference reference data over 2019–2024.
//
...
// ── Run calibration ─────────────────────────────────────────────────
console.log('\nPhase 3 calibration — fitting second epicycle to sky-reference\n');
...
// Keep uranus/neptune unchanged (no sky-reference reference fetched yet)
