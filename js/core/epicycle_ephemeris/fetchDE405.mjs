...
const CACHE  = '/tmp/sky-reference_cache';
...
writeFileSync('/home/claude/epicycle_ephemeris/sky-reference_reference.json', JSON.stringify(result));
const total = Object.values(result).reduce((s,a)=>s+a.length,0);
console.log(`\nWrote sky-reference_reference.json  (${total} total rows)`);
