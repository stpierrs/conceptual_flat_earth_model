...
- **Calibration note:** Mars perturbation phases (terms 2–6) are approximate; run
  `phase3Calibrate.mjs` against sky-reference to optimise them.
...
- Chunk 5 (Uranus/Neptune): added `uranusLonCorr(t)` (4 terms, Saturn+Jupiter coupling)
  ...
  Phases approximate — need phase3Calibrate.mjs vs sky-reference to refine.
...
Phases approximate — calibrate with `phase3Calibrate.mjs` vs sky-reference.
