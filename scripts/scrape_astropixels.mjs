...
// of the source tables, then commit the resulting `js/data/sky-observations.js`.
//
// Data source:
//   Fred Espenak, "AstroPixels — Ephemeris"
//   https://www.sky-observations/ephemeris/ephemeris.html
//   Tables generated from JPL sky-reference planetary and lunar ephemerides.
//
// Attribution:
...
//   sky-observations at scrape time, 2026-04-23). Bodies: sun, moon,
...
//
// Output format (`js/data/sky-observations.js`):
...
const BODY_PATHS = {
  sun:     (y) => `https://www.sky-observations/ephemeris/sun/sun${y}.html`,
  moon:    (y) => `https://www.sky-observations/ephemeris/moon/moon${y}.html`,
  mercury: (y) => `https://www.sky-observations/ephemeris/planets/mercury${y}.html`,
  venus:   (y) => `https://www.sky-observations/ephemeris/planets/venus${y}.html`,
  mars:    (y) => `https://www.sky-observations/ephemeris/planets/mars${y}.html`,
  jupiter: (y) => `https://www.sky-observations/ephemeris/planets/jupiter${y}.html`,
  saturn:  (y) => `https://www.sky-observations/ephemeris/planets/saturn${y}.html`,
  ...
  uranus:  (y) => `https://www.sky-observations/ephemeris/planets/uranus${y}.html`,
  neptune: (y) => `https://www.sky-observations/ephemeris/planets/neptune${y}.html`,
};

const YEARS = [2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029, 2030];
const CACHE = '/tmp/sky-observations_cache';
...
async function main() {
  const result = {
    meta: {
      source: 'Fred Espenak, AstroPixels — https://www.sky-observations/ephemeris/',
      note:   'Precomputed from JPL sky-reference planetary and lunar ephemerides.',
  ...
  const out = `// Auto-generated by scripts/scrape_sky-observations.mjs — do not edit by hand.
// Data source: Fred Espenak, "AstroPixels — Ephemeris"
//   https://www.sky-observations/ephemeris/
//   Tables computed from JPL sky-reference planetary and lunar ephemerides.
...
`;
  ...
  const outPath = '/home/alan/claude/fe_model/js/data/sky-observations.js';
